module.exports = async (client) => {
  ...
  for (const guild of leftGuilds) {
    ...
    client.logger.info(`Encounter has left ${guild.guild_name}`);
  }

  client.logger.info('Encounter is now online');
  client.logger.info(`Encounter is running on ${client.guilds.cache.size} server(s)`);
};
