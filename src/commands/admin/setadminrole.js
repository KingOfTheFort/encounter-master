...
module.exports = class SetAdminRoleCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description: 'Sets the `administrator role` for your server. Provide no role to clear the current `administrator role`.',
  ...
  run(message, args) {
    ...
    const embed = new MessageEmbed()
      .setTitle('Settings: `administrator role`')
      .setThumbnail(message.guild.iconURL({ dynamic: true }))
      .setDescription(`The \`administrator role\` was successfully updated. ${success}`)
